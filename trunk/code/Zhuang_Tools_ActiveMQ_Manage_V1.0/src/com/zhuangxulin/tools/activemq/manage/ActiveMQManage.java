 ...
 *
 */
package com.zhuangxulin.tools.activemq.manage;
...
public class ActiveMQManage {
	...
	protected String bindAddress = "tcp://119.161.240.232:61616";
//	protected String username = "zhuangxulin";
//	protected String password = "ludandan";
	...
	public void printSystemUsage(SystemUsage syUage) {
		...
		System.out.println("memeryUsage PercentUsage name ="
		...
		System.out.println("storeUsage PercentUsage name ="
...
//		answer.addConnector(bindAddress);
	...
	public static void main(String[] args) throws Exception {
		ActiveMQManage monitor=new ActiveMQManage();  
		monitor.init();
		
		QueueViewMBean qvm = monitor.getQueue("SMS.SendSMS");
		System.out.println("consume count:"+qvm.getConsumerCount());
		System.out.println("cursor memorg usage:"+qvm.getCursorMemoryUsage());
		System.out.println("cursor percent usage:"+qvm.getCursorPercentUsage());
		System.out.println("dequeue count:"+qvm.getDequeueCount());
		System.out.println("dispatch count:"+qvm.getDispatchCount());
		System.out.println("enqueue count:"+qvm.getEnqueueCount());
		System.out.println("expired count:"+qvm.getExpiredCount());
		System.out.println("filght count:"+qvm.getInFlightCount());
		monitor.monitorMermeryUsage();
	}
