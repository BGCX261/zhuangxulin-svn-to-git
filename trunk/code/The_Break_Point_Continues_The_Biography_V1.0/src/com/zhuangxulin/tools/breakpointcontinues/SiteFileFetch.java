...
public class SiteFileFetch extends Thread {
	/**
	 * @uml.property  name="siteInfoBean"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	SiteInfoBean siteInfoBean = null; // 文件信息 Bean
	/**
	 * @uml.property  name="nStartPos" multiplicity="(0 -1)" dimension="1"
	 */
	long[] nStartPos; // 开始位置
	/**
	 * @uml.property  name="nEndPos" multiplicity="(0 -1)" dimension="1"
	 */
	long[] nEndPos; // 结束位置
	/**
	 * @uml.property  name="fileSplitterFetch"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	FileSplitterFetch[] fileSplitterFetch; // 子线程对象
	/**
	 * @uml.property  name="nFileLength"
	 */
	...
	/**
	 * @uml.property  name="bStop"
	 */
	boolean bStop = false; // 停止标志
	/**
	 * @uml.property  name="tmpFile"
	 */
